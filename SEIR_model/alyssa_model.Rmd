...
set_vacc <- function(disease, type) {
  ...
  if (type == "No Vaccination"){
    ...
    vaccS <- function(t){0}
      ...
      if (disease == "COVID-19") {
        vaccC <- vacc_weekly(0.6423, WVH, k)
        vaccCA <- vacc_weekly(0.6973, WVH, k)
        vaccP <- vacc_weekly(0.6973, WVH, k)
        vaccS <- vacc_weekly(0.8628, WVH, k)
      } else if (disease == "Flu") {
        vaccC <- vacc_weekly(0.5976, WVH, k)
        vaccCA <- vacc_weekly(0.3669, WVH, k)
        vaccP <- vacc_weekly(0.4909, WVH, k)
        vaccS <- vacc_weekly(0.6129, WVH, k)
      } else if (disease == "RSV") {
        vaccC <- vacc_weekly(0.468, WVH, k)
        vaccCA <- vacc_weekly(0, WVH, k)
        vaccP <- vacc_weekly(0, WVH, k)
        vaccS <- vacc_weekly(0, WVH, k)
      } else if (disease == "Pertussis") {
        vaccC <- vacc_weekly(0.86, WVH, k)
        vaccCA <- vacc_weekly(0, WVH, k)
        vaccP <- vacc_weekly(0, WVH, k)
        vaccS <- vacc_weekly(0, WVH, k)
      }
    ...
    if (disease == "COVID-19") {
        vaccC <- vacc_weekly(0.6973, WVH, k)
        vaccCA <- vacc_weekly(0.6973, WVH, k)
        vaccP <- vacc_weekly(0.6973, WVH, k)
        vaccS <- vacc_weekly(0.8628, WVH, k)
    } else if (disease == "Flu") {
        vaccC <- vacc_weekly(0.5976, WVH, k)
        vaccCA <- vacc_weekly(0.5976, WVH, k)
        vaccP <- vacc_weekly(0.5976, WVH, k)
        vaccS <- vacc_weekly(0.6129, WVH, k)
    } else if (disease == "RSV") {
        vaccC <- vacc_weekly(0.468, WVH, k)
        vaccCA <- vacc_weekly(0.468, WVH, k)
        vaccP <- vacc_weekly(0.468, WVH, k)
        vaccS <- vacc_weekly(0.468, WVH, k)
    } else if (disease == "Pertussis") {
        vaccC <- vacc_weekly(0.86, WVH, k)
        vaccCA <- vacc_weekly(0.86, WVH, k)
        vaccP <- vacc_weekly(0.86, WVH, k)
        vaccS <- vacc_weekly(0.86, WVH, k)
    }
  }
...
COVIDplotInfections60prop <- infection_plot_prop(COVIDoutGrouped, "COVID-19 Infections Proportion (60 days)", 0, 60)
ggsave("figures/COVIDplotInfections60prop.png", width = 10, height = 7, dpi = 300)

COVIDplotInfections500ct <- infection_plot(COVIDoutGrouped, "COVID-19 Infections Count (500 days)", 0, 500)
ggsave("figures/COVIDplotInfections500ct.png", width = 10, height = 7, dpi = 300)
COVIDplotInfectionsprop <- infection_plot_prop(COVIDoutGrouped, "COVID-19 Infections Proportion (500 days)", 0, 500)
ggsave("figures/COVIDplotInfections500prop.png", width = 10, height = 7, dpi = 300)

COVIDplotInfections5yrct <- infection_plot(COVIDoutGrouped, "COVID-19 Infections Count (5 years)", 1826, NULL)
ggsave("figures/COVIDplotInfections5yrct.png", width = 10, height = 7, dpi = 300)
COVIDplotInfections5yrprop <- infection_plot_prop(COVIDoutGrouped, "COVID-19 Infections Proportion (5 years)", 1826, NULL)
...
FLUplotInfections5yrct <- infection_plot(FLUoutGrouped, "Flu Infections Count (5 years)", 1826, NULL)
ggsave("figures/FLUplotInfections5yrct.png", width = 10, height = 7, dpi = 300)
FLUplotInfections5yrprop <- infection_plot_prop(FLUoutGrouped, "Flu Infections Proportion (5 years)", 1826, NULL)
...
RSVplotInfections5yrct <- infection_plot(RSVoutGrouped, "RSV Infections Count (5 years)", 1826, NULL)
ggsave("figures/RSVplotInfections5yrct.png", width = 10, height = 7, dpi = 300)
RSVplotInfections5yrprop <- infection_plot_prop(RSVoutGrouped, "RSV Infections Proportion (5 years)", 1826, NULL)
...
PERTplotInfections5yrct <- infection_plot(PERToutGrouped, "Pertussis Infections Count (5 years)", 1826, NULL)
ggsave("figures/PERTplotInfections5yrct.png", width = 10, height = 7, dpi = 300)
PERTplotInfections5yrprop <- infection_plot_prop(PERToutGrouped, "Pertussis Infections Proportion (5 years)", 1826, NULL)
