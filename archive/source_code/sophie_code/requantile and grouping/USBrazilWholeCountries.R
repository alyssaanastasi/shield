...
setwd("C:/Users/sophi/Box/Vaccine_inequity/Data/final/Brazil/Finished sets")
...
Brazil100$nbin[Brazil100$nbin == 5] <- "L"
...
write.csv(full,"C:/Users/sophi/Box/Vaccine_inequity/Data/data_figures/BrazilUSGiniAggregate.csv", row.names = FALSE)
