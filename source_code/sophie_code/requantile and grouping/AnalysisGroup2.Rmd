...
dataKOinc <- dataKO[c("location", "measure", "value")] %>%
  ...
  dataKOinc$nbin[dataKOinc$nbin == 5] <- "H"
  ...
  ungroup()
   ...
   dataKOpov$nbin[dataKOpov$nbin == 5] <- "L"
...
dataUSinc2 <- dataUS2[c("location", "measure", "value", "state")] %>%
  ...
  dataUSinc2$nbin[dataUSinc2$nbin == 5] <- "H"
...
dataUSpov2 <- dataUS2[c("location", "measure", "value", "state")] %>%
  ...
  dataUSpov2$nbin[dataUSpov2$nbin == 5] <- "L"
...
ggplot(aes(x = week, y = value)) + geom_line(aes(color = bin, group = bin), alpha=.25) + theme_minimal() + facet_grid(~state)
plot
```
...
write.csv(makeCSV,"C:/Users/sophi/Box/Vaccine_inequity/Data/final/makeCSV2_5.csv", row.names = FALSE)

write.csv(dataMaster,"C:/Users/sophi/Box/Vaccine_inequity/Data/final/loc2_5.csv", row.names = FALSE)
