...
ungroup()
  ...
  Brazil12$nbin[Brazil12$nbin == 5] <- "L"
...
write.csv(Brazil,"C:/Users/sophi/Box/Vaccine_inequity/Data/final/locBr_5.csv", row.names = FALSE)
...
write.csv(makeCSV,"C:/Users/sophi/Box/Vaccine_inequity/Data/final/Brazil_5.csv", row.names = FALSE)
```
## test
```{r}
