...
flist=c(
  dE_C_RSV_vax=quote((beta_RSV*
                        ...
                        (cCC*(I_C_RSV + si_RSV*I_C_RSV_vax + H_C_RSV + si_RSV*H_C_RSV_vax)/popC + 
                           cCOC*(I_OC_RSV + si_RSV*I_OC_RSV_vax + H_OC_RSV + si_RSV*H_OC_RSV_vax)/popOC + 
                           cCA*(I_A_RSV + si_RSV*I_A_RSV_vax + H_A_RSV + si_RSV*H_A_RSV_vax)/popA + 
                           cCS*(I_S_RSV + si_RSV*I_S_RSV_vax + H_S_RSV + si_RSV*H_S_RSV_vax)/popS) * vaccC_RSV * ve_RSV)*R_C_COV +
                        (beta_RSV*
                        (cCC*(I_C_RSV + si_RSV*I_C_RSV_vax + H_C_RSV + si_RSV*H_C_RSV_vax)/popC + 
                           cCOC*(I_OC_RSV + si_RSV*I_OC_RSV_vax + H_OC_RSV + si_RSV*H_OC_RSV_vax)/popOC + 
                           cCA*(I_A_RSV + si_RSV*I_A_RSV_vax + H_A_RSV + si_RSV*H_A_RSV_vax)/popA + 
                           cCS*(I_S_RSV + si_RSV*I_S_RSV_vax + H_S_RSV + si_RSV*H_S_RSV_vax)/popS) * vaccC_RSV * ve_RSV)*R_C_FLU ), # (lambda * vacc * VE)*S + (lambda * vacc * VE)*R_COV + (lambda * vacc * VE)*R_FLU
  ...
  dE_C_RSV=quote(((beta_RSV*
                   ...
                   ((beta_RSV*
                     (cCC*(I_C_RSV + si_RSV*I_C_RSV_vax + H_C_RSV + si_RSV*H_C_RSV_vax)/popC + 
                        cCOC*(I_OC_RSV + si_RSV*I_OC_RSV_vax + H_OC_RSV + si_RSV*H_OC_RSV_vax)/popOC + 
                        cCA*(I_A_RSV + si_RSV*I_A_RSV_vax + H_A_RSV + si_RSV*H_A_RSV_vax)/popA + 
                        cCS*(I_S_RSV + si_RSV*I_S_RSV_vax + H_S_RSV + si_RSV*H_S_RSV_vax)/popS)) * (1-vaccC_RSV))*R_C_COV +
                   ((beta_RSV*
                     (cCC*(I_C_RSV + si_RSV*I_C_RSV_vax + H_C_RSV + si_RSV*H_C_RSV_vax)/popC + 
                        cCOC*(I_OC_RSV + si_RSV*I_OC_RSV_vax + H_OC_RSV + si_RSV*H_OC_RSV_vax)/popOC + 
                        cCA*(I_A_RSV + si_RSV*I_A_RSV_vax + H_A_RSV + si_RSV*H_A_RSV_vax)/popA + 
                        cCS*(I_S_RSV + si_RSV*I_S_RSV_vax + H_S_RSV + si_RSV*H_S_RSV_vax)/popS)) * (1-vaccC_RSV))*R_C_FLU ), 
  dI_C_RSV=quote(0),
  dH_C_RSV=quote(0),
                      ...
                      vaccOC_RSV * ve_RSV)*S_OC +
                        (beta_RSV*
                         (cOCC*(I_C_RSV + si_RSV*I_C_RSV_vax + H_C_RSV + si_RSV*H_C_RSV_vax)/popC + 
                            cOCOC*(I_OC_RSV + si_RSV*I_OC_RSV_vax + H_OC_RSV + si_RSV*H_OC_RSV_vax)/popOC + 
                            cOCA*(I_A_RSV + si_RSV*I_A_RSV_vax + H_A_RSV + si_RSV*H_A_RSV_vax)/popA + 
                            cOCS*(I_S_RSV + si_RSV*I_S_RSV_vax + H_S_RSV + si_RSV*H_S_RSV_vax)/popS) * vaccOC_RSV * ve_RSV)*R_OC_COV +
                        (beta_RSV*
                         (cOCC*(I_C_RSV + si_RSV*I_C_RSV_vax + H_C_RSV + si_RSV*H_C_RSV_vax)/popC + 
                            cOCOC*(I_OC_RSV + si_RSV*I_OC_RSV_vax + H_OC_RSV + si_RSV*H_OC_RSV_vax)/popOC + 
                            cOCA*(I_A_RSV + si_RSV*I_A_RSV_vax + H_A_RSV + si_RSV*H_A_RSV_vax)/popA + 
                            cOCS*(I_S_RSV + si_RSV*I_S_RSV_vax + H_S_RSV + si_RSV*H_S_RSV_vax)/popS) * vaccOC_RSV * ve_RSV)*R_OC_FLU),
  ...
  dE_OC_RSV=quote(((beta_RSV*
                   ...
                   ((beta_RSV*
                      (cOCC*(I_C_RSV + si_RSV*I_C_RSV_vax + H_C_RSV + si_RSV*H_C_RSV_vax)/popC + 
                         cOCOC*(I_OC_RSV + si_RSV*I_OC_RSV_vax + H_OC_RSV + si_RSV*H_OC_RSV_vax)/popOC + 
                         cOCA*(I_A_RSV + si_RSV*I_A_RSV_vax + H_A_RSV + si_RSV*H_A_RSV_vax)/popA + 
                         cOCS*(I_S_RSV + si_RSV*I_S_RSV_vax + H_S_RSV + si_RSV*H_S_RSV_vax)/popS)) * (1-vaccOC_RSV))*R_OC_COV +
                   ((beta_RSV*
                      (cOCC*(I_C_RSV + si_RSV*I_C_RSV_vax + H_C_RSV + si_RSV*H_C_RSV_vax)/popC + 
                         cOCOC*(I_OC_RSV + si_RSV*I_OC_RSV_vax + H_OC_RSV + si_RSV*H_OC_RSV_vax)/popOC + 
                         cOCA*(I_A_RSV + si_RSV*I_A_RSV_vax + H_A_RSV + si_RSV*H_A_RSV_vax)/popA + 
                         cOCS*(I_S_RSV + si_RSV*I_S_RSV_vax + H_S_RSV + si_RSV*H_S_RSV_vax)/popS)) * (1-vaccOC_RSV))*R_OC_FLU ), 
  dI_OC_RSV=quote(0),
  dH_OC_RSV=quote(0),
  dE_A_RSV_vax=quote((beta_RSV*
                       ...
                       vaccA_RSV * ve_RSV)*S_A +
                        ...
                        (cAC*(I_C_RSV + si_RSV*I_C_RSV_vax + H_C_RSV + si_RSV*H_C_RSV_vax)/popC + 
                           cAOC*(I_OC_RSV + si_RSV*I_OC_RSV_vax + H_OC_RSV + si_RSV*H_OC_RSV_vax)/popOC + 
                           cAA*(I_A_RSV + si_RSV*I_A_RSV_vax + H_A_RSV + si_RSV*H_A_RSV_vax)/popA + 
                           cAS*(I_S_RSV + si_RSV*I_S_RSV_vax + H_S_RSV + si_RSV*H_S_RSV_vax)/popS) * vaccA_RSV * ve_RSV)*R_A_COV +
                        (beta_RSV*
                        (cAC*(I_C_RSV + si_RSV*I_C_RSV_vax + H_C_RSV + si_RSV*H_C_RSV_vax)/popC + 
                           cAOC*(I_OC_RSV + si_RSV*I_OC_RSV_vax + H_OC_RSV + si_RSV*H_OC_RSV_vax)/popOC + 
                           cAA*(I_A_RSV + si_RSV*I_A_RSV_vax + H_A_RSV + si_RSV*H_A_RSV_vax)/popA + 
                           cAS*(I_S_RSV + si_RSV*I_S_RSV_vax + H_S_RSV + si_RSV*H_S_RSV_vax)/popS) * vaccA_RSV * ve_RSV)*R_A_FLU),
  ...
  dE_A_RSV=quote(((beta_RSV*
                   ...
                   ((beta_RSV*
                     (cAC*(I_C_RSV + si_RSV*I_C_RSV_vax + H_C_RSV + si_RSV*H_C_RSV_vax)/popC + 
                        cAOC*(I_OC_RSV + si_RSV*I_OC_RSV_vax + H_OC_RSV + si_RSV*H_OC_RSV_vax)/popOC + 
                        cAA*(I_A_RSV + si_RSV*I_A_RSV_vax + H_A_RSV + si_RSV*H_A_RSV_vax)/popA + 
                        cAS*(I_S_RSV + si_RSV*I_S_RSV_vax + H_S_RSV + si_RSV*H_S_RSV_vax)/popS)) * (1-vaccA_RSV))*R_A_COV +
                   ((beta_RSV*
                     (cAC*(I_C_RSV + si_RSV*I_C_RSV_vax + H_C_RSV + si_RSV*H_C_RSV_vax)/popC + 
                        cAOC*(I_OC_RSV + si_RSV*I_OC_RSV_vax + H_OC_RSV + si_RSV*H_OC_RSV_vax)/popOC + 
                        cAA*(I_A_RSV + si_RSV*I_A_RSV_vax + H_A_RSV + si_RSV*H_A_RSV_vax)/popA + 
                        cAS*(I_S_RSV + si_RSV*I_S_RSV_vax + H_S_RSV + si_RSV*H_S_RSV_vax)/popS)) * (1-vaccA_RSV))*R_A_FLU), 
  dI_A_RSV=quote(0),
  dH_A_RSV=quote(0),
  dE_S_RSV_vax=quote((beta_RSV*
                      ...
                      vaccS_RSV * ve_RSV)*S_S +
                        ...
                        (cSC*(I_C_RSV + si_RSV*I_C_RSV_vax + H_C_RSV + si_RSV*H_C_RSV_vax)/popC + 
                           cSOC*(I_OC_RSV + si_RSV*I_OC_RSV_vax + H_OC_RSV + si_RSV*H_OC_RSV_vax)/popOC + 
                           cSA*(I_A_RSV + si_RSV*I_A_RSV_vax + H_A_RSV + si_RSV*H_A_RSV_vax)/popA + 
                           cSS*(I_S_RSV + si_RSV*I_S_RSV_vax + H_S_RSV + si_RSV*H_S_RSV_vax)/popS) * vaccS_RSV * ve_RSV)*R_S_COV +
                        (beta_RSV*
                        (cSC*(I_C_RSV + si_RSV*I_C_RSV_vax + H_C_RSV + si_RSV*H_C_RSV_vax)/popC + 
                           cSOC*(I_OC_RSV + si_RSV*I_OC_RSV_vax + H_OC_RSV + si_RSV*H_OC_RSV_vax)/popOC + 
                           cSA*(I_A_RSV + si_RSV*I_A_RSV_vax + H_A_RSV + si_RSV*H_A_RSV_vax)/popA + 
                           cSS*(I_S_RSV + si_RSV*I_S_RSV_vax + H_S_RSV + si_RSV*H_S_RSV_vax)/popS) * vaccS_RSV * ve_RSV)*R_S_FLU),
  ...
  dE_S_RSV=quote(((beta_RSV*
                   ...
                   ((beta_RSV*
                     (cSC*(I_C_RSV + si_RSV*I_C_RSV_vax + H_C_RSV + si_RSV*H_C_RSV_vax)/popC + 
                        cSOC*(I_OC_RSV + si_RSV*I_OC_RSV_vax + H_OC_RSV + si_RSV*H_OC_RSV_vax)/popOC + 
                        cSA*(I_A_RSV + si_RSV*I_A_RSV_vax + H_A_RSV + si_RSV*H_A_RSV_vax)/popA + 
                        cSS*(I_S_RSV + si_RSV*I_S_RSV_vax + H_S_RSV + si_RSV*H_S_RSV_vax)/popS)) * (1-vaccS_RSV))*R_S_COV +
                   ((beta_RSV*
                     (cSC*(I_C_RSV + si_RSV*I_C_RSV_vax + H_C_RSV + si_RSV*H_C_RSV_vax)/popC + 
                        cSOC*(I_OC_RSV + si_RSV*I_OC_RSV_vax + H_OC_RSV + si_RSV*H_OC_RSV_vax)/popOC + 
                        cSA*(I_A_RSV + si_RSV*I_A_RSV_vax + H_A_RSV + si_RSV*H_A_RSV_vax)/popA + 
                        cSS*(I_S_RSV + si_RSV*I_S_RSV_vax + H_S_RSV + si_RSV*H_S_RSV_vax)/popS)) * (1-vaccS_RSV))*R_S_FLU), 
  dI_S_RSV=quote(0),
  dH_S_RSV=quote(0))
...
df = list(S_C = Pop_children, S_OC = Pop_older_children, S_A = Pop_adult, S_S = Pop_senior,
          ...
          R_C_COV=0, R_OC_COV=0, R_A_COV=0, R_S_COV=0,
          R_C_FLU=0, R_OC_FLU=0, R_A_FLU=0, R_S_FLU=0
          )
...
for (i in seq_along(beta_seq)){
  ...
  RSVR0_grid <- RSVR0_grid %>% rbind(tibble(R0_value = R0, beta = beta_seq[i]))
  ...
  dE_C_COV_vax=quote((beta_COV*
                       ...
                       (beta_COV*
                          (cCC*(I_C_COV + si_COV*I_C_COV_vax + H_C_COV + si_COV*H_C_COV_vax)/popC + 
                             cCOC*(I_OC_COV + si_COV*I_OC_COV_vax + H_OC_COV + si_COV*H_OC_COV_vax)/popOC + 
                             cCA*(I_A_COV + si_COV*I_A_COV_vax + H_A_COV + si_COV*H_A_COV_vax)/popA + 
                             cCS*(I_S_COV + si_COV*I_S_COV_vax + H_S_COV + si_COV*H_S_COV_vax)/popS) * vaccC_COV * ve_COV)*R_C_RSV +
                       (beta_COV*
                          (cCC*(I_C_COV + si_COV*I_C_COV_vax + H_C_COV + si_COV*H_C_COV_vax)/popC + 
                             cCOC*(I_OC_COV + si_COV*I_OC_COV_vax + H_OC_COV + si_COV*H_OC_COV_vax)/popOC + 
                             cCA*(I_A_COV + si_COV*I_A_COV_vax + H_A_COV + si_COV*H_A_COV_vax)/popA + 
                             cCS*(I_S_COV + si_COV*I_S_COV_vax + H_S_COV + si_COV*H_S_COV_vax)/popS) * vaccC_COV * ve_COV)*R_C_FLU ), # (lambda * vacc * VE)*S + (lambda * vacc * VE)*R_COV + (lambda * vacc * VE)*R_FLU
  ...
  dE_C_COV=quote(((beta_COV*
                   ...
                   ((beta_COV*
                       (cCC*(I_C_COV + si_COV*I_C_COV_vax + H_C_COV + si_COV*H_C_COV_vax)/popC + 
                          cCOC*(I_OC_COV + si_COV*I_OC_COV_vax + H_OC_COV + si_COV*H_OC_COV_vax)/popOC + 
                          cCA*(I_A_COV + si_COV*I_A_COV_vax + H_A_COV + si_COV*H_A_COV_vax)/popA + 
                          cCS*(I_S_COV + si_COV*I_S_COV_vax + H_S_COV + si_COV*H_S_COV_vax)/popS)) * (1-vaccC_COV))*R_C_RSV +
                   ((beta_COV*
                       (cCC*(I_C_COV + si_COV*I_C_COV_vax + H_C_COV + si_COV*H_C_COV_vax)/popC + 
                          cCOC*(I_OC_COV + si_COV*I_OC_COV_vax + H_OC_COV + si_COV*H_OC_COV_vax)/popOC + 
                          cCA*(I_A_COV + si_COV*I_A_COV_vax + H_A_COV + si_COV*H_A_COV_vax)/popA + 
                          cCS*(I_S_COV + si_COV*I_S_COV_vax + H_S_COV + si_COV*H_S_COV_vax)/popS)) * (1-vaccC_COV))*R_C_FLU ), 
  dI_C_COV=quote(0),
  dH_C_COV=quote(0),
  dE_OC_COV_vax=quote((beta_COV*
                        ...
                        (beta_COV*
                           (cOCC*(I_C_COV + si_COV*I_C_COV_vax + H_C_COV + si_COV*H_C_COV_vax)/popC + 
                              cOCOC*(I_OC_COV + si_COV*I_OC_COV_vax + H_OC_COV + si_COV*H_OC_COV_vax)/popOC + 
                              cOCA*(I_A_COV + si_COV*I_A_COV_vax + H_A_COV + si_COV*H_A_COV_vax)/popA + 
                              cOCS*(I_S_COV + si_COV*I_S_COV_vax + H_S_COV + si_COV*H_S_COV_vax)/popS) * vaccOC_COV * ve_COV)*R_OC_RSV +
                        (beta_COV*
                           (cOCC*(I_C_COV + si_COV*I_C_COV_vax + H_C_COV + si_COV*H_C_COV_vax)/popC + 
                              cOCOC*(I_OC_COV + si_COV*I_OC_COV_vax + H_OC_COV + si_COV*H_OC_COV_vax)/popOC + 
                              cOCA*(I_A_COV + si_COV*I_A_COV_vax + H_A_COV + si_COV*H_A_COV_vax)/popA + 
                              cOCS*(I_S_COV + si_COV*I_S_COV_vax + H_S_COV + si_COV*H_S_COV_vax)/popS) * vaccOC_COV * ve_COV)*R_OC_FLU),
  ...
  dE_OC_COV=quote(((beta_COV*
                    ...
                    ((beta_COV*
                        (cOCC*(I_C_COV + si_COV*I_C_COV_vax + H_C_COV + si_COV*H_C_COV_vax)/popC + 
                           cOCOC*(I_OC_COV + si_COV*I_OC_COV_vax + H_OC_COV + si_COV*H_OC_COV_vax)/popOC + 
                           cOCA*(I_A_COV + si_COV*I_A_COV_vax + H_A_COV + si_COV*H_A_COV_vax)/popA + 
                           cOCS*(I_S_COV + si_COV*I_S_COV_vax + H_S_COV + si_COV*H_S_COV_vax)/popS)) * (1-vaccOC_COV))*R_OC_RSV +
                    ((beta_COV*
                        (cOCC*(I_C_COV + si_COV*I_C_COV_vax + H_C_COV + si_COV*H_C_COV_vax)/popC + 
                           cOCOC*(I_OC_COV + si_COV*I_OC_COV_vax + H_OC_COV + si_COV*H_OC_COV_vax)/popOC + 
                           cOCA*(I_A_COV + si_COV*I_A_COV_vax + H_A_COV + si_COV*H_A_COV_vax)/popA + 
                           cOCS*(I_S_COV + si_COV*I_S_COV_vax + H_S_COV + si_COV*H_S_COV_vax)/popS)) * (1-vaccOC_COV))*R_OC_FLU ), 
  dI_OC_COV=quote(0),
  dH_OC_COV=quote(0),
  dE_A_COV_vax=quote((beta_COV*
                       ...
                       (beta_COV*
                          (cAC*(I_C_COV + si_COV*I_C_COV_vax + H_C_COV + si_COV*H_C_COV_vax)/popC + 
                             cAOC*(I_OC_COV + si_COV*I_OC_COV_vax + H_OC_COV + si_COV*H_OC_COV_vax)/popOC + 
                             cAA*(I_A_COV + si_COV*I_A_COV_vax + H_A_COV + si_COV*H_A_COV_vax)/popA + 
                             cAS*(I_S_COV + si_COV*I_S_COV_vax + H_S_COV + si_COV*H_S_COV_vax)/popS) * vaccA_COV * ve_COV)*R_A_RSV +
                       (beta_COV*
                          (cAC*(I_C_COV + si_COV*I_C_COV_vax + H_C_COV + si_COV*H_C_COV_vax)/popC + 
                             cAOC*(I_OC_COV + si_COV*I_OC_COV_vax + H_OC_COV + si_COV*H_OC_COV_vax)/popOC + 
                             cAA*(I_A_COV + si_COV*I_A_COV_vax + H_A_COV + si_COV*H_A_COV_vax)/popA + 
                             cAS*(I_S_COV + si_COV*I_S_COV_vax + H_S_COV + si_COV*H_S_COV_vax)/popS) * vaccA_COV * ve_COV)*R_A_FLU),
  ...
  dE_A_COV=quote(((beta_COV*
                   ...
                   ((beta_COV*
                       (cAC*(I_C_COV + si_COV*I_C_COV_vax + H_C_COV + si_COV*H_C_COV_vax)/popC + 
                          cAOC*(I_OC_COV + si_COV*I_OC_COV_vax + H_OC_COV + si_COV*H_OC_COV_vax)/popOC + 
                          cAA*(I_A_COV + si_COV*I_A_COV_vax + H_A_COV + si_COV*H_A_COV_vax)/popA + 
                          cAS*(I_S_COV + si_COV*I_S_COV_vax + H_S_COV + si_COV*H_S_COV_vax)/popS)) * (1-vaccA_COV))*R_A_RSV +
                   ((beta_COV*
                       (cAC*(I_C_COV + si_COV*I_C_COV_vax + H_C_COV + si_COV*H_C_COV_vax)/popC + 
                          cAOC*(I_OC_COV + si_COV*I_OC_COV_vax + H_OC_COV + si_COV*H_OC_COV_vax)/popOC + 
                          cAA*(I_A_COV + si_COV*I_A_COV_vax + H_A_COV + si_COV*H_A_COV_vax)/popA + 
                          cAS*(I_S_COV + si_COV*I_S_COV_vax + H_S_COV + si_COV*H_S_COV_vax)/popS)) * (1-vaccA_COV))*R_A_FLU), 
  dI_A_COV=quote(0),
  dH_A_COV=quote(0),
  dE_S_COV_vax=quote((beta_COV*
                       ...
                       (beta_COV*
                          (cSC*(I_C_COV + si_COV*I_C_COV_vax + H_C_COV + si_COV*H_C_COV_vax)/popC + 
                             cSOC*(I_OC_COV + si_COV*I_OC_COV_vax + H_OC_COV + si_COV*H_OC_COV_vax)/popOC + 
                             cSA*(I_A_COV + si_COV*I_A_COV_vax + H_A_COV + si_COV*H_A_COV_vax)/popA + 
                             cSS*(I_S_COV + si_COV*I_S_COV_vax + H_S_COV + si_COV*H_S_COV_vax)/popS) * vaccS_COV * ve_COV)*R_S_RSV +
                       (beta_COV*
                          (cSC*(I_C_COV + si_COV*I_C_COV_vax + H_C_COV + si_COV*H_C_COV_vax)/popC + 
                             cSOC*(I_OC_COV + si_COV*I_OC_COV_vax + H_OC_COV + si_COV*H_OC_COV_vax)/popOC + 
                             cSA*(I_A_COV + si_COV*I_A_COV_vax + H_A_COV + si_COV*H_A_COV_vax)/popA + 
                             cSS*(I_S_COV + si_COV*I_S_COV_vax + H_S_COV + si_COV*H_S_COV_vax)/popS) * vaccS_COV * ve_COV)*R_S_FLU),
  ...
  dE_S_COV=quote(((beta_COV*
                   ...
                   ((beta_COV*
                       (cSC*(I_C_COV + si_COV*I_C_COV_vax + H_C_COV + si_COV*H_C_COV_vax)/popC + 
                          cSOC*(I_OC_COV + si_COV*I_OC_COV_vax + H_OC_COV + si_COV*H_OC_COV_vax)/popOC + 
                          cSA*(I_A_COV + si_COV*I_A_COV_vax + H_A_COV + si_COV*H_A_COV_vax)/popA + 
                          cSS*(I_S_COV + si_COV*I_S_COV_vax + H_S_COV + si_COV*H_S_COV_vax)/popS)) * (1-vaccS_COV))*R_S_RSV +
                   ((beta_COV*
                       (cSC*(I_C_COV + si_COV*I_C_COV_vax + H_C_COV + si_COV*H_C_COV_vax)/popC + 
                          cSOC*(I_OC_COV + si_COV*I_OC_COV_vax + H_OC_COV + si_COV*H_OC_COV_vax)/popOC + 
                          cSA*(I_A_COV + si_COV*I_A_COV_vax + H_A_COV + si_COV*H_A_COV_vax)/popA + 
                          cSS*(I_S_COV + si_COV*I_S_COV_vax + H_S_COV + si_COV*H_S_COV_vax)/popS)) * (1-vaccS_COV))*R_S_FLU), 
  dI_S_COV=quote(0),
  dH_S_COV=quote(0))
...
para = list( beta_COV=10*(0.27/5), epsilon_COV = 1/3, omega_COV = 1/(6*30), gammaI_COV = 1/5, gammaH_COV = 1/15, 
...
df = list(S_C = Pop_children, S_OC = Pop_older_children, S_A = Pop_adult, S_S = Pop_senior,
          ...
          R_C_RSV=0, R_OC_RSV=0, R_A_RSV=0, R_S_RSV=0,
          R_C_FLU=0, R_OC_FLU=0, R_A_FLU=0, R_S_FLU=0
)
...
for (i in seq_along(beta_seq)){
  ...
  COVR0_grid <- COVR0_grid %>% rbind(tibble(R0_value = R0, beta = beta_seq[i]))
  ...
  dE_C_FLU_vax=quote((beta_FLU*
                       ...
                       (beta_FLU*
                          (cCC*(I_C_FLU + si_FLU*I_C_FLU_vax + H_C_FLU + si_FLU*H_C_FLU_vax)/popC + 
                             cCOC*(I_OC_FLU + si_FLU*I_OC_FLU_vax + H_OC_FLU + si_FLU*H_OC_FLU_vax)/popOC + 
                             cCA*(I_A_FLU + si_FLU*I_A_FLU_vax + H_A_FLU + si_FLU*H_A_FLU_vax)/popA + 
                             cCS*(I_S_FLU + si_FLU*I_S_FLU_vax + H_S_FLU + si_FLU*H_S_FLU_vax)/popS) * vaccC_FLU * ve_FLU)*R_C_RSV +
                       (beta_FLU*
                          (cCC*(I_C_FLU + si_FLU*I_C_FLU_vax + H_C_FLU + si_FLU*H_C_FLU_vax)/popC + 
                             cCOC*(I_OC_FLU + si_FLU*I_OC_FLU_vax + H_OC_FLU + si_FLU*H_OC_FLU_vax)/popOC + 
                             cCA*(I_A_FLU + si_FLU*I_A_FLU_vax + H_A_FLU + si_FLU*H_A_FLU_vax)/popA + 
                             cCS*(I_S_FLU + si_FLU*I_S_FLU_vax + H_S_FLU + si_FLU*H_S_FLU_vax)/popS) * vaccC_FLU * ve_FLU)*R_C_COV ), # (lambda * vacc * VE)*S + (lambda * vacc * VE)*R_FLU + (lambda * vacc * VE)*R_FLU
  ...
  dE_C_FLU=quote(((beta_FLU*
                   ...
                   ((beta_FLU*
                       (cCC*(I_C_FLU + si_FLU*I_C_FLU_vax + H_C_FLU + si_FLU*H_C_FLU_vax)/popC + 
                          cCOC*(I_OC_FLU + si_FLU*I_OC_FLU_vax + H_OC_FLU + si_FLU*H_OC_FLU_vax)/popOC + 
                          cCA*(I_A_FLU + si_FLU*I_A_FLU_vax + H_A_FLU + si_FLU*H_A_FLU_vax)/popA + 
                          cCS*(I_S_FLU + si_FLU*I_S_FLU_vax + H_S_FLU + si_FLU*H_S_FLU_vax)/popS)) * (1-vaccC_FLU))*R_C_RSV +
                   ((beta_FLU*
                       (cCC*(I_C_FLU + si_FLU*I_C_FLU_vax + H_C_FLU + si_FLU*H_C_FLU_vax)/popC + 
                          cCOC*(I_OC_FLU + si_FLU*I_OC_FLU_vax + H_OC_FLU + si_FLU*H_OC_FLU_vax)/popOC + 
                          cCA*(I_A_FLU + si_FLU*I_A_FLU_vax + H_A_FLU + si_FLU*H_A_FLU_vax)/popA + 
                          cCS*(I_S_FLU + si_FLU*I_S_FLU_vax + H_S_FLU + si_FLU*H_S_FLU_vax)/popS)) * (1-vaccC_FLU))*R_C_COV ), 
  dI_C_FLU=quote(0),
  dH_C_FLU=quote(0),
  dE_OC_FLU_vax=quote((beta_FLU*
                        ...
                        (beta_FLU*
                           (cOCC*(I_C_FLU + si_FLU*I_C_FLU_vax + H_C_FLU + si_FLU*H_C_FLU_vax)/popC + 
                              cOCOC*(I_OC_FLU + si_FLU*I_OC_FLU_vax + H_OC_FLU + si_FLU*H_OC_FLU_vax)/popOC + 
                              cOCA*(I_A_FLU + si_FLU*I_A_FLU_vax + H_A_FLU + si_FLU*H_A_FLU_vax)/popA + 
                              cOCS*(I_S_FLU + si_FLU*I_S_FLU_vax + H_S_FLU + si_FLU*H_S_FLU_vax)/popS) * vaccOC_FLU * ve_FLU)*R_OC_RSV +
                        (beta_FLU*
                           (cOCC*(I_C_FLU + si_FLU*I_C_FLU_vax + H_C_FLU + si_FLU*H_C_FLU_vax)/popC + 
                              cOCOC*(I_OC_FLU + si_FLU*I_OC_FLU_vax + H_OC_FLU + si_FLU*H_OC_FLU_vax)/popOC + 
                              cOCA*(I_A_FLU + si_FLU*I_A_FLU_vax + H_A_FLU + si_FLU*H_A_FLU_vax)/popA + 
                              cOCS*(I_S_FLU + si_FLU*I_S_FLU_vax + H_S_FLU + si_FLU*H_S_FLU_vax)/popS) * vaccOC_FLU * ve_FLU)*R_OC_COV),
  ...
  dE_OC_FLU=quote(((beta_FLU*
                    ...
                    ((beta_FLU*
                        (cOCC*(I_C_FLU + si_FLU*I_C_FLU_vax + H_C_FLU + si_FLU*H_C_FLU_vax)/popC + 
                           cOCOC*(I_OC_FLU + si_FLU*I_OC_FLU_vax + H_OC_FLU + si_FLU*H_OC_FLU_vax)/popOC + 
                           cOCA*(I_A_FLU + si_FLU*I_A_FLU_vax + H_A_FLU + si_FLU*H_A_FLU_vax)/popA + 
                           cOCS*(I_S_FLU + si_FLU*I_S_FLU_vax + H_S_FLU + si_FLU*H_S_FLU_vax)/popS)) * (1-vaccOC_FLU))*R_OC_RSV +
                    ((beta_FLU*
                        (cOCC*(I_C_FLU + si_FLU*I_C_FLU_vax + H_C_FLU + si_FLU*H_C_FLU_vax)/popC + 
                           cOCOC*(I_OC_FLU + si_FLU*I_OC_FLU_vax + H_OC_FLU + si_FLU*H_OC_FLU_vax)/popOC + 
                           cOCA*(I_A_FLU + si_FLU*I_A_FLU_vax + H_A_FLU + si_FLU*H_A_FLU_vax)/popA + 
                           cOCS*(I_S_FLU + si_FLU*I_S_FLU_vax + H_S_FLU + si_FLU*H_S_FLU_vax)/popS)) * (1-vaccOC_FLU))*R_OC_COV ), 
  dI_OC_FLU=quote(0),
  dH_OC_FLU=quote(0),
  dE_A_FLU_vax=quote((beta_FLU*
                       ...
                       (beta_FLU*
                          (cAC*(I_C_FLU + si_FLU*I_C_FLU_vax + H_C_FLU + si_FLU*H_C_FLU_vax)/popC + 
                             cAOC*(I_OC_FLU + si_FLU*I_OC_FLU_vax + H_OC_FLU + si_FLU*H_OC_FLU_vax)/popOC + 
                             cAA*(I_A_FLU + si_FLU*I_A_FLU_vax + H_A_FLU + si_FLU*H_A_FLU_vax)/popA + 
                             cAS*(I_S_FLU + si_FLU*I_S_FLU_vax + H_S_FLU + si_FLU*H_S_FLU_vax)/popS) * vaccA_FLU * ve_FLU)*R_A_RSV +
                       (beta_FLU*
                          (cAC*(I_C_FLU + si_FLU*I_C_FLU_vax + H_C_FLU + si_FLU*H_C_FLU_vax)/popC + 
                             cAOC*(I_OC_FLU + si_FLU*I_OC_FLU_vax + H_OC_FLU + si_FLU*H_OC_FLU_vax)/popOC + 
                             cAA*(I_A_FLU + si_FLU*I_A_FLU_vax + H_A_FLU + si_FLU*H_A_FLU_vax)/popA + 
                             cAS*(I_S_FLU + si_FLU*I_S_FLU_vax + H_S_FLU + si_FLU*H_S_FLU_vax)/popS) * vaccA_FLU * ve_FLU)*R_A_COV),
  ...
  dE_A_FLU=quote(((beta_FLU*
                   ...
                   ((beta_FLU*
                       (cAC*(I_C_FLU + si_FLU*I_C_FLU_vax + H_C_FLU + si_FLU*H_C_FLU_vax)/popC + 
                          cAOC*(I_OC_FLU + si_FLU*I_OC_FLU_vax + H_OC_FLU + si_FLU*H_OC_FLU_vax)/popOC + 
                          cAA*(I_A_FLU + si_FLU*I_A_FLU_vax + H_A_FLU + si_FLU*H_A_FLU_vax)/popA + 
                          cAS*(I_S_FLU + si_FLU*I_S_FLU_vax + H_S_FLU + si_FLU*H_S_FLU_vax)/popS)) * (1-vaccA_FLU))*R_A_RSV +
                   ((beta_FLU*
                       (cAC*(I_C_FLU + si_FLU*I_C_FLU_vax + H_C_FLU + si_FLU*H_C_FLU_vax)/popC + 
                          cAOC*(I_OC_FLU + si_FLU*I_OC_FLU_vax + H_OC_FLU + si_FLU*H_OC_FLU_vax)/popOC + 
                          cAA*(I_A_FLU + si_FLU*I_A_FLU_vax + H_A_FLU + si_FLU*H_A_FLU_vax)/popA + 
                          cAS*(I_S_FLU + si_FLU*I_S_FLU_vax + H_S_FLU + si_FLU*H_S_FLU_vax)/popS)) * (1-vaccA_FLU))*R_A_COV), 
  dI_A_FLU=quote(0),
  dH_A_FLU=quote(0),
  dE_S_FLU_vax=quote((beta_FLU*
                       ...
                       (beta_FLU*
                          (cSC*(I_C_FLU + si_FLU*I_C_FLU_vax + H_C_FLU + si_FLU*H_C_FLU_vax)/popC + 
                             cSOC*(I_OC_FLU + si_FLU*I_OC_FLU_vax + H_OC_FLU + si_FLU*H_OC_FLU_vax)/popOC + 
                             cSA*(I_A_FLU + si_FLU*I_A_FLU_vax + H_A_FLU + si_FLU*H_A_FLU_vax)/popA + 
                             cSS*(I_S_FLU + si_FLU*I_S_FLU_vax + H_S_FLU + si_FLU*H_S_FLU_vax)/popS) * vaccS_FLU * ve_FLU)*R_S_RSV +
                       (beta_FLU*
                          (cSC*(I_C_FLU + si_FLU*I_C_FLU_vax + H_C_FLU + si_FLU*H_C_FLU_vax)/popC + 
                             cSOC*(I_OC_FLU + si_FLU*I_OC_FLU_vax + H_OC_FLU + si_FLU*H_OC_FLU_vax)/popOC + 
                             cSA*(I_A_FLU + si_FLU*I_A_FLU_vax + H_A_FLU + si_FLU*H_A_FLU_vax)/popA + 
                             cSS*(I_S_FLU + si_FLU*I_S_FLU_vax + H_S_FLU + si_FLU*H_S_FLU_vax)/popS) * vaccS_FLU * ve_FLU)*R_S_COV),
  ...
  dE_S_FLU=quote(((beta_FLU*
                   ...
                   ((beta_FLU*
                       (cSC*(I_C_FLU + si_FLU*I_C_FLU_vax + H_C_FLU + si_FLU*H_C_FLU_vax)/popC + 
                          cSOC*(I_OC_FLU + si_FLU*I_OC_FLU_vax + H_OC_FLU + si_FLU*H_OC_FLU_vax)/popOC + 
                          cSA*(I_A_FLU + si_FLU*I_A_FLU_vax + H_A_FLU + si_FLU*H_A_FLU_vax)/popA + 
                          cSS*(I_S_FLU + si_FLU*I_S_FLU_vax + H_S_FLU + si_FLU*H_S_FLU_vax)/popS)) * (1-vaccS_FLU))*R_S_RSV +
                   ((beta_FLU*
                       (cSC*(I_C_FLU + si_FLU*I_C_FLU_vax + H_C_FLU + si_FLU*H_C_FLU_vax)/popC + 
                          cSOC*(I_OC_FLU + si_FLU*I_OC_FLU_vax + H_OC_FLU + si_FLU*H_OC_FLU_vax)/popOC + 
                          cSA*(I_A_FLU + si_FLU*I_A_FLU_vax + H_A_FLU + si_FLU*H_A_FLU_vax)/popA + 
                          cSS*(I_S_FLU + si_FLU*I_S_FLU_vax + H_S_FLU + si_FLU*H_S_FLU_vax)/popS)) * (1-vaccS_FLU))*R_S_COV), 
  dI_S_FLU=quote(0),
  dH_S_FLU=quote(0))
...
para = list( beta_FLU=10*(0.27/5), epsilon_FLU = 1/3, omega_FLU = 1/(3*30), gammaI_FLU = 1/7, gammaH_FLU = 1/11,  
...
for (i in seq_along(beta_seq)){
  ...
  FLUR0_grid <- FLUR0_grid %>% rbind(tibble(R0_value = R0, beta = beta_seq[i]))
