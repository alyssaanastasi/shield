...
seir <- function(t, y, pars){
  ...
  RSV_C = c(E_C_RSV_vax, I_C_RSV_vax, H_C_RSV_vax,
           E_C_RSV, I_C_RSV, H_C_RSV, R_C_RSV)
  ...
  RSV_OC = c(E_OC_RSV_vax, I_OC_RSV_vax, H_OC_RSV_vax,
              E_OC_RSV, I_OC_RSV, H_OC_RSV, R_OC_RSV)
  ...
  RSV_A = c(E_A_RSV_vax, I_A_RSV_vax, H_A_RSV_vax,
            E_A_RSV, I_A_RSV, H_A_RSV, R_A_RSV)
  ...
  RSV_S = c(E_S_RSV_vax, I_S_RSV_vax, H_S_RSV_vax,
            E_S_RSV, I_S_RSV, H_S_RSV, R_S_RSV)
  ...
  COV_C = c(E_C_COV_vax, I_C_COV_vax, H_C_COV_vax,
            E_C_COV, I_C_COV, H_C_COV, R_C_COV)
  ...
  COV_OC = c(E_OC_COV_vax, I_OC_COV_vax, H_OC_COV_vax,
             E_OC_COV, I_OC_COV, H_OC_COV, R_OC_COV)
  ...
  COV_A = c(E_A_COV_vax, I_A_COV_vax, H_A_COV_vax,
            E_A_COV, I_A_COV, H_A_COV, R_A_COV)
  ...
  COV_S = c(E_S_COV_vax, I_S_COV_vax, H_S_COV_vax,
            E_S_COV, I_S_COV, H_S_COV, R_S_COV)
  ...
  FLU_C = c(E_C_FLU_vax, I_C_FLU_vax, H_C_FLU_vax,
            E_C_FLU, I_C_FLU, H_C_FLU, R_C_FLU)
  ...
  FLU_OC = c(E_OC_FLU_vax, I_OC_FLU_vax, H_OC_FLU_vax,
             E_OC_FLU, I_OC_FLU, H_OC_FLU, R_OC_FLU)
  ...
  FLU_A = c(E_A_FLU_vax, I_A_FLU_vax, H_A_FLU_vax,
            E_A_FLU, I_A_FLU, H_A_FLU, R_A_FLU)
  ...
  FLU_S = c(E_S_FLU_vax, I_S_FLU_vax, H_S_FLU_vax,
            E_S_FLU, I_S_FLU, H_S_FLU, R_S_FLU)
  ...
  dR_OC_RSV <- (1-probHOC_RSV)*gammaI_RSV*I_OC_RSV + (1-alphaOC_RSV)*gammaH_RSV*H_OC_RSV - omega_RSV*R_OC_RSV -
              (lambdaOC_COV * vaccC_COV * ve_COV)*R_OC_RSV -
  ...
  dR_A_RSV <- (1-probHA_RSV)*gammaI_RSV*I_A_RSV + (1-alphaA_RSV)*gammaH_RSV*H_A_RSV - omega_RSV*R_A_RSV -
              ...
              (lambdaA_FLU * (1 - vaccA_FLU)) * RA_RSV
